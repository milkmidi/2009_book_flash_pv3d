package {	
	...
	public class MiniCarouselReflectionView extends MovieClip{
		...
		private function init3DEngine():void{
			...
			//建構ReflectionView物件, 其建構時的參數和BasicView類別相同。
			view.viewportReflection.filters = [new BlurFilter(2, 2, 3)];
			//view物件其viewportReflection屬性可以屬到反射物件, 其型別是Sprite。
			//為該物件增加BlurFilter效果。
			view.viewportReflection.alpha = .8;
			//透明度。
			view.surfaceHeight = -160; 
			//設定反射面的 y 軸方向高度
