...
//		var ball:MovieClip;
		...
		public function playBall():void {
			...
			Tweener.addTween(ball, {x:p2.x, y:p2.y, _bezier:bezierList, time:1, transition:"linear"});
		...
		public function redraw():void {
			...
			cs += "import caurina.transitions.properties.CurveModifiers;\n";
			cs += "CurveModifiers.init();\n"
			cs += "\n";
